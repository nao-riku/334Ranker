...
def interval3(until, index, driver):
    ...
    while True:
        if until < datetime.datetime.now():
            if until <= datetime.datetime(start_now.year, start_now.month, start_now.day, 7, 6, 48):
...
def start():
    ...
    times = [
        ...
        [datetime.datetime(start_now.year, start_now.month, start_now.day, 4, 33, 0), datetime.datetime(start_now.year, start_now.month, start_now.day, 7, 7, 0)], #4:03
        [datetime.datetime(start_now.year, start_now.month, start_now.day, 7, 7, 0), datetime.datetime(start_now.year, start_now.month, start_now.day, 12, 33, 0)], #8:03
    ...
    for i in range(len(times)):
        if start_now < times[i][0]:
            ...
            threading.Thread(target=interval3, args=(datetime.datetime(start_now.year, start_now.month, start_now.day, 7, 5, 0), 0, driver,)).start()
