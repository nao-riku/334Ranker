...
def interval3(until, index, driver):
    ...
    while True:
        if until < datetime.datetime.now():
            if until <= datetime.datetime(start_now.year, start_now.month, start_now.day, 6, 44, 48):
...
def start():
    ...
    times = [
        ...
        [datetime.datetime(start_now.year, start_now.month, start_now.day, 4, 33, 0), datetime.datetime(start_now.year, start_now.month, start_now.day, 6, 45, 0)], #4:03
        [datetime.datetime(start_now.year, start_now.month, start_now.day, 6, 45, 0), datetime.datetime(start_now.year, start_now.month, start_now.day, 12, 33, 0)], #8:03
